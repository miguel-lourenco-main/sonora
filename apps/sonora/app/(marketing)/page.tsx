          ...
          >
            <FeatureGrid>
              <FeatureCard
                ...
                description={`Sonora provides a beautiful dashboard to manage your SaaS business.`}
              >
                <Image
              ...
              <FeatureCard
                ...
                description={`Sonora provides a variety of providers to allow your users to sign in.`}
              >
                <Image
              ...
              <FeatureCard
                ...
                label={'Billing'}
                description={`Sonora supports multiple payment gateways to charge your customers.`}
              >
                <Image
