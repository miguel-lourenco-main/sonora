...
By default, it's set to 0, which will disable the feature.
  ...
  }): Promise<GenerateTextResultWorkflow<TOOLS>> {
  ...
  return new GenerateTextResultWorkflow({
 ...
 */
export class GenerateTextResultWorkflow<TOOLS extends Record<string, CoreTool>> {
  /**
The generated text.
   */
 ...
 */
export const experimental_generateText = generateTextWorkflow;
