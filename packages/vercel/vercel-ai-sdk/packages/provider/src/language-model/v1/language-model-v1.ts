...
export type LanguageModelV1StreamPart =
  // Basic text deltas:
  | { type: 'text-delta'; role:string; textDelta: string }
  ...
  // specific type to accomodate for getting responses from our custom backend
  | { type: 'backend-response'; role: string; content: string }
