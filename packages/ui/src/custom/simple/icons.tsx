...
function IconEdgen({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      id="Camada_1"
      data-name="Camada 1"
      viewBox="0 0 169.73073 248.00175"
      version="1.1"
      width="169.73073"
      height="248.00174"
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <path
        d="m 164.52765,111.32183 -55.01031,-0.27657 a 5.2404632,5.2404632 0 0 1 -4.74553,-7.3949 L 148.16574,7.4005306 a 5.2404632,5.2404632 0 0 0 -8.31193,-6.026535 L 1.7093475,127.49449 a 5.2404632,5.2404632 0 0 0 3.508207,9.11258 l 54.9957515,0.30569 a 5.2404632,5.2404632 0 0 1 4.74553,7.39488 l -43.393953,96.29349 a 5.2404632,5.2404632 0 0 0 8.31196,6.02655 L 168.02129,120.43441 a 5.2404632,5.2404632 0 0 0 -3.49364,-9.11258 z"
        style={{ strokeWidth: '1.45569', fill: '#ffd000' }}
      />
    </svg>
  );
}
...
function IconPDF({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    ...
    >
      ...
      />
      <path
        d="M165.33 190.58V196.37H153V202.96H162.52V208.49H153V220.65H145.72V190.58H165.33Z"
        fill="white"
      />
      <path
...
function IconDOCX({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      width="201"
      height="240"
